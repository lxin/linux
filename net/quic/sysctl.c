...
static struct ctl_table quic_net_table[] = {
	{
		...
		.data		= &init_net.quic.p.max_udp_payload_size,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		...
		.data		= &init_net.quic.p.initial_max_data,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		...
		.data		= &init_net.quic.p.initial_max_stream_data_bidi_local,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		...
		.data		= &init_net.quic.p.initial_max_stream_data_bidi_remote,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		...
		.data		= &init_net.quic.p.initial_max_stream_data_uni,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		...
		.data		= &init_net.quic.p.initial_max_streams_bidi,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		...
		.data		= &init_net.quic.p.initial_max_streams_uni,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
